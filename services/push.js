...
async function sendToUser(userId, title, body, data) {
  ...
  try {
    const r = await admin.messaging().sendEachForMulticast({
      ...
      data: dataStr, tokens,
      android: { priority: 'high', notification: { sound: 'default', channelId: 'bipbip_default', imageUrl: process.env.PUSH_IMAGE_URL || 'https://bipbiprecharge.ci/assets/logo-minia.png' } }
    });
    if (r.responses) {
